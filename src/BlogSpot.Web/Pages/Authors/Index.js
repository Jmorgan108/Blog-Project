$(function () {
    ...
    var dataTable = $('#AuthorsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(blogSpot.authors.author.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('BlogSpot.Authors.Edit'),
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('BlogSpot.Authors.Delete'),
